...
import { MessageSquare, Bell, Calendar, Pill, User } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-8">
        <h1 className="text-3xl font-bold mb-6">{translate("messages.title", "Messages")}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center space-x-2">
              ...
              <CardTitle>{translate("messages.medicationAlerts", "Medication Alerts")}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center space-x-2">
              ...
              <CardTitle>{translate("messages.appointmentAlerts", "Appointment Alerts")}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-3 bg-secondary/50 rounded-lg">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center space-x-2">
              ...
              <CardTitle>{translate("messages.doctorsMessages", "Doctor's Messages")}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-3 bg-secondary/50 rounded-lg">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center space-x-2">
              ...
              <CardTitle>{translate("messages.generalNotifications", "General Notifications")}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-3 bg-secondary/50 rounded-lg">
